!(function (e, t) {
  ...
  return function (e) {
    ...
    if (
      ('object' == typeof a.target && (null === a.target || !a.target instanceof HTMLCanvasElement)) ||
      ('string' == typeof a.target &&
        (null === document.getElementById(a.target) || !document.getElementById(a.target) instanceof HTMLCanvasElement))
    )
      throw new ReferenceError('The target element does not exist or is not a canvas element')
    var t = 'object' == typeof a.target ? a.target : document.getElementById(a.target),
      o = t.getContext('2d'),
      r = []
    function n(e, t) {
      e = e || 1
    ...
    function s() {
      ...
      return {
        ...
        x: n(a.width),
        y: a.start_from_edge ? (a.clock < 0 ? parseFloat(a.height) + 10 : -10) : n(a.height),
        src: e.src,
        radius: n(4) + 1,
        size: e.size,
        rotate: a.rotate,
    ...
    function l(e) {
      if (e)
        switch (((o.fillStyle = o.strokeStyle = 'rgba(' + e.color + ', ' + (3 < e.radius ? 0.8 : 0.4) + ')'), o.beginPath(), e.prop)) {
          case 'circle':
            o.moveTo(e.x, e.y), o.arc(e.x, e.y, e.radius * a.size, 0, 2 * Math.PI, !0), o.fill()
            break
          case 'triangle':
            o.moveTo(e.x, e.y),
            ...
            break
          case 'line':
            o.moveTo(e.x, e.y), o.lineTo(e.x + e.line * a.size, e.y + 5 * e.radius), (o.lineWidth = 2 * a.size), o.stroke()
            break
          case 'square':
            o.save(),
          ...
          case 'svg':
            ...
            o.translate(e.x + r / 2, e.y + r / 2),
              ...
              o.drawImage(t, (-r / 2) * a.size, (-r / 2) * a.size, r * a.size, r * a.size),
              o.restore()
        }
    }
    function c() {
          ...
          !(function () {
            for (var e = 0; e < a.max; e++) {
              ...
              t &&
                ...
                ((0 <= t.speed && a.height < t.y) || (t.speed < 0 && t.y < 0)) &&
                  (a.respawn ? ((r[e] = t), (r[e].x = n(a.width, !0)), (r[e].y = t.speed < 0 ? parseFloat(a.height) : -10)) : (r[e] = void 0)))
            }
            r.every(function (e) {
              return void 0 === e
            }) && c()
